node{
    ...
    stage('git code checkout'){
        try{
            ...
            git 'https://github.com/Veda-Sr/star-agile-insurance-project.git'
        }
        catch(Exception e){
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'vedasriram2003@gmail.com'
        }
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} login -u veda25 -p ${dockerHubPassword}"
        sh "${dockerCMD} push veda25/insure-me:${tagName}"
